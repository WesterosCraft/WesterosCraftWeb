...
import { Box, Center, Flex, Container, VStack, Text, Checkbox, HStack } from '@chakra-ui/react';
...
export const getStaticProps: GetStaticProps = async () => {
  const pageData = await sanityClient.fetch(`*[_type == "page" && slug.current == "progress"]{
    ...,
